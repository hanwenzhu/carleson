...
/--
For all real numbers $x\ge 4$, $$\begin{equation*}
...
@[blueprint
  ...
  (proof := /--
  By convexity, for all $0\le\lambda\le1$ $$\begin{equation*}
          2^{\lambda(-\frac{1}{4})} \le \lambda 2^{-\frac{1}{4}} + (1-\lambda)2^0.
  \end{equation*}$$ For $\lambda:=\frac{4}{x}$, we obtain $$\begin{equation*}
          2^{-\frac 1 x} \le 1 - (1-2^{-\frac 1 4}) \frac{4}{x}.
  \end{equation*}$$ We conclude $$\begin{equation*}
